...
| `site.test.mjs` | De landingspagina in zeven talen: de generator is gedraaid, per taal de juiste taal, titel- en omschrijvingslengte, één h1, canonical en wederkerige hreflang, geldige JSON-LD waarvan de FAQ woord voor woord op het scherm staat, de punten uit de app, contrast in licht en donker, geen horizontale scroll en elk woord past in zijn kop. Plus: niets van andere hosts, geen 404, de app op noindex, en sitemap, robots.txt, llms.txt en 404.html; de niveaus (Simpel, Klassiek, Gevorderd) met de vragen en punten uit de presets van de app, startlichten 1-3-5, en het echte aantal vragen in de tekst. En de beweging: blokken schuiven pas in beeld als je erbij bent, tellers eindigen op het echte getal, de voortgangsbalk loopt vol, de lichtkrant wordt niet voorgelezen; zonder JavaScript, met minder beweging of zonder het script onderaan staat alles er toch |
