  ...
  nl: {
    ...
    functies: {
      ...
      items: [
        ...
        ['Delen in de groepsapp', 'Eén tik zet de uitslag van het weekend klaar als tekst voor WhatsApp.'],
        ['Deadlines in je agenda', 'Abonneer je op de agenda en elke deadline staat in je eigen kalender, met je eigen herinnering.'],
        ['Vergeten in te vullen?', 'Met automatisch invullen krijgt wie niets inlevert de WK-stand als top 10, in plaats van nul punten.'],
    ...
    faq: {
      ...
      items: [
        ...
        ['Wat als ik een race vergeet?', 'Dan scoor je voor dat weekend niets, tenzij de poulebaas automatisch invullen heeft aangezet: dan krijg je de WK-stand als top 10. Er is ook een stand zonder je slechtste weekenden, zodat één gemiste race je seizoen niet verpest.'],
    ...
    voet: {
      ...
      app: 'Open de app', bron: 'Broncode op GitHub', data: 'Uitslagen via OpenF1', talen: 'Deze pagina in het',
    },
  ...
  en: {
    ...
    functies: {
      ...
      items: [
        ...
        ['Share in your group chat', 'One tap prepares the weekend result as text for WhatsApp.'],
        ...
        ['Forgot to predict?', 'With auto-fill switched on, anyone who submits nothing gets the championship order as their top 10 instead of zero.'],
    ...
    faq: {
      ...
      items: [
        ...
        ['What if I forget a race?', 'Then you score nothing that weekend, unless the league admin has switched on auto-fill: then you get the championship order as your top 10. There is also a table without your worst weekends, so one missed race does not ruin your season.'],
    ...
    voet: {
      ...
      app: 'Open the app', bron: 'Source code on GitHub', data: 'Results via OpenF1', talen: 'This page in',
    },
  ...
  de: {
    ...
    functies: {
      ...
      items: [
        ...
        ['In der Gruppe teilen', 'Ein Tipp bereitet das Wochenendergebnis als Text für WhatsApp vor.'],
        ...
        ['Tipp vergessen?', 'Mit automatischem Ausfüllen bekommt, wer nichts abgibt, die WM-Reihenfolge als Top 10 statt null Punkte.'],
    ...
    faq: {
      ...
      items: [
        ...
        ['Was, wenn ich ein Rennen vergesse?', 'Dann bekommst du für dieses Wochenende keine Punkte, es sei denn, der Admin hat das automatische Ausfüllen eingeschaltet: Dann bekommst du die WM-Reihenfolge als Top 10. Es gibt auch eine Tabelle ohne deine schlechtesten Wochenenden, damit ein verpasstes Rennen nicht deine Saison ruiniert.'],
    ...
    voet: {
      ...
      app: 'App öffnen', bron: 'Quellcode auf GitHub', data: 'Ergebnisse über OpenF1', talen: 'Diese Seite auf',
    },
  ...
  fr: {
    ...
    functies: {
      ...
      items: [
        ...
        ['Partage dans le groupe', 'Un geste prépare le résultat du week-end en texte pour WhatsApp.'],
        ...
        ['Oublié de pronostiquer ?', 'Avec le remplissage automatique, celui qui n\'envoie rien reçoit l\'ordre du championnat comme top 10 au lieu de zéro.'],
    ...
    faq: {
      ...
      items: [
        ...
        ['Et si j\'oublie une course ?', 'Vous ne marquez rien ce week-end-là, sauf si l\'administrateur a activé le remplissage automatique : vous recevez alors l\'ordre du championnat comme top 10. Il existe aussi un classement sans vos pires week-ends, pour qu\'une course manquée ne gâche pas votre saison.'],
    ...
    voet: {
      ...
      app: 'Ouvrir l\'appli', bron: 'Code source sur GitHub', data: 'Résultats via OpenF1', talen: 'Cette page en',
    },
  ...
  es: {
    ...
    functies: {
      ...
      items: [
        ...
        ['Comparte en tu grupo', 'Un toque prepara el resultado del fin de semana como texto para WhatsApp.'],
        ['Plazos en tu calendario', 'Suscríbete al calendario y cada plazo aparece en tu propio calendario, con tu propio aviso.'],
        ['¿Se te olvidó?', 'Con el relleno automático, quien no envía nada recibe el orden del mundial como top 10 en lugar de cero.'],
    ...
    faq: {
      ...
      items: [
        ...
        ['¿Y si me olvido de una carrera?', 'Ese fin de semana no sumas nada, salvo que el administrador haya activado el relleno automático: entonces recibes el orden del mundial como top 10. También hay una clasificación sin tus peores fines de semana, para que una carrera olvidada no arruine tu temporada.'],
    ...
    voet: {
      ...
      app: 'Abrir la app', bron: 'Código fuente en GitHub', data: 'Resultados vía OpenF1', talen: 'Esta página en',
    },
  ...
  it: {
    ...
    functies: {
      ...
      items: [
        ...
        ['Condividi nel gruppo', 'Un tocco prepara il risultato del weekend come testo per WhatsApp.'],
        ['Scadenze nel calendario', 'Iscriviti al calendario e ogni scadenza compare nel tuo calendario, con il tuo promemoria.'],
        ['Dimenticato il pronostico?', 'Con la compilazione automatica, chi non invia nulla riceve l\'ordine del mondiale come top 10 invece di zero.'],
    ...
    faq: {
      ...
      items: [
        ...
        ['E se mi dimentico una gara?', 'Quel weekend non fai punti, a meno che l\'amministratore non abbia attivato la compilazione automatica: allora ricevi l\'ordine del mondiale come top 10. C\'è anche una classifica senza i tuoi weekend peggiori, così una gara saltata non rovina la tua stagione.'],
    ...
    voet: {
      ...
      app: 'Apri l\'app', bron: 'Codice sorgente su GitHub', data: 'Risultati tramite OpenF1', talen: 'Questa pagina in',
    },
  ...
  pt: {
    ...
    functies: {
      ...
      items: [
        ...
        ['Compartilhe no grupo', 'Um toque prepara o resultado do fim de semana como texto para o WhatsApp.'],
        ['Prazos na sua agenda', 'Assine a agenda e cada prazo aparece no seu próprio calendário, com o seu lembrete.'],
        ['Esqueceu o palpite?', 'Com o preenchimento automático, quem não envia nada recebe a ordem do campeonato como top 10 em vez de zero.'],
    ...
    faq: {
      ...
      items: [
        ...
        ['E se eu esquecer uma corrida?', 'Você não pontua naquele fim de semana, a não ser que o administrador tenha ligado o preenchimento automático: aí você recebe a ordem do campeonato como top 10. Também existe uma classificação sem os seus piores fins de semana, para que uma corrida esquecida não estrague sua temporada.'],
    ...
    voet: {
      ...
      app: 'Abrir o app', bron: 'Código-fonte no GitHub', data: 'Resultados via OpenF1', talen: 'Esta página em',
    },
