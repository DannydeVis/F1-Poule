  ...
  nl: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Wat als ik een race vergeet?', 'Dan scoor je voor dat weekend niets, tenzij de poulebaas automatisch invullen heeft aangezet: dan krijg je de WK-stand als top 10.'],
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        ['What if I forget a race?', 'Then you score nothing that weekend, unless the league admin has switched on auto-fill: then you get the championship order as your top 10.'],
  ...
  de: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Was, wenn ich ein Rennen vergesse?', 'Dann bekommst du für dieses Wochenende keine Punkte, es sei denn, der Admin hat das automatische Ausfüllen eingeschaltet: Dann bekommst du die WM-Reihenfolge als Top 10.'],
  ...
  fr: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Et si j\'oublie une course ?', 'Vous ne marquez rien ce week-end-là, sauf si l\'administrateur a activé le remplissage automatique : vous recevez alors l\'ordre du championnat comme top 10.'],
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        ['¿Y si me olvido de una carrera?', 'Ese fin de semana no sumas nada, salvo que el administrador haya activado el relleno automático: entonces recibes el orden del mundial como top 10.'],
  ...
  it: {
    ...
    faq: {
      ...
      items: [
        ...
        ['E se mi dimentico una gara?', 'Quel weekend non fai punti, a meno che l\'amministratore non abbia attivato la compilazione automatica: allora ricevi l\'ordine del mondiale come top 10.'],
  ...
  pt: {
    ...
    faq: {
      ...
      items: [
        ...
        ['E se eu esquecer uma corrida?', 'Você não pontua naquele fim de semana, a não ser que o administrador tenha ligado o preenchimento automático: aí você recebe a ordem do campeonato como top 10.'],
